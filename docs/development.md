...
Find the [latest release of JDK 25](https://adoptium.net/temurin/releases/?version=25) and extract it to the `/opt` directory:
```
wget https://github.com/adoptium/temurin25-binaries/releases/download/jdk-25.0.4.1%2B1/OpenJDK25U-jdk_x64_linux_hotspot_25.0.4.1_1.tar.gz
tar xvf OpenJDK25U-jdk_x64_linux_hotspot_25.0.4.1_1.tar.gz
